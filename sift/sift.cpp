/**example script for usage of SIFT method in opencv
...
/*     BFMatcher matcher;
    ...
    imwrite("sift_match_1+keypoint.png", img1_keypoint);
    imwrite("sift_match_2+keypoint.png", img2_keypoint);

    //-- Draw matches
    Mat img_matches;
    drawMatches( img1, keypoints_1, img2, keypoints_2, good_matches, img_matches, Scalar::all(-1),
                 Scalar::all(-1), vector<char>(), DrawMatchesFlags::NOT_DRAW_SINGLE_POINTS );
    imwrite("sift_match_c++.png", img_matches);
    //-- Show detected matches
    namedWindow("SIFT match", CV_WINDOW_AUTOSIZE);
